...
\begin{document}
	...
	\minitoc
		\section{Objectifs}
			\input{textes/objectifs}

		\section{Définitions préliminaires}
			\input{textes/definitionsPreliminaires}

		\section{Le quadtree}
			\input{textes/quadtree}
	\chapter{L'algorithme}
		\section{Déroulement}
			\input{textes/deroulement}
		\section{Le lissage}
			\input{textes/quadtreeSmoothing}
		\section{Classification statistique}
			\input{textes/classificationStatistique}
		\section{Estimation de la frontière}
			\input{textes/estimationFrontiere}
